...
type Handler struct {
	service skilllevel.Service
}

func NewHandler(service skilllevel.Service) *Handler {
...
func (h *Handler) List(c *gin.Context) {
	...
	items := make([]SkillLevelResponse, len(list))
	for i, s := range list {
		items[i] = NewSkillLevelResponse(s)
	}
...
func (h *Handler) Get(c *gin.Context) {
	...
	c.JSON(http.StatusOK, NewSkillLevelResponse(s))
}
...
func (h *Handler) Create(c *gin.Context) {
	...
	c.JSON(http.StatusCreated, NewSkillLevelResponse(s))
}
